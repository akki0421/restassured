...
public class SlotFindingForFutureDate {
    static String startDate;
    static String endDate;
    static JsonArray ListOfAvailableSlotsOnTheGivenDate;
    static Cookies cookie;

    public static Object[] SlotFindingForFutureDate_35DaysAdded() throws IOException {
//        Process ps = new Process();
        ...
        //System.out.println(availableSlots[0]);
        //System.out.println(availableSlots[1]);
        //System.out.println(availableSlots[2]);
